...
# class_name_to_id = {v: k for k, v in self.class_id_to_name.items()}


class EUROSAT_CTRS:

    def __init__(self, data_dir='eurosat', split='train', depth_transform='rgb', label_type='clip_vitb32', margin=0.1, n_neg=3, is_embedding_set=False, dataset_threshold=0.9) -> None:
        ...
        if self.label_type == 'clip_vitb32':
            ...
            print(f"Keep ratio: {confident_mask.mean():.2f}")
...
if __name__ == '__main__':
    dataset_train = NYU2_CTRS(split='train', data_dir='../../dbs/eurosat', depth_transform='rgb')
    dataset_train_embedding = NYU2_CTRS(split='train', data_dir='../../dbs/eurosat', depth_transform='rgb', is_embedding_set=True)
